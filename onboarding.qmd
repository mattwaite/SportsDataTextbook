...
1.  [Download the latest version of R from CRAN](https://cran.rstudio.com/) for Mac.
...
1.  [Download R 4.2.2 from CRAN](https://cran.rstudio.com/) for Windows. The numbers in the screenshots below are 4.0.2, but the process is the same.
